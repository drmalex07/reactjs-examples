...
const SelectLanguage = require('./select-language');
...
class ContentRoot extends React.Component {
  ...
  {
    // Note:
    // Provide target components as functional components (gives access to lexical `this`).
        ...
        <div className="root"> {/* a router has a single skeletal child */}
          ...
          <div className="content">
            ...
            <Switch> {/* match only 1st of following routes */}
              ...
              <Route path="/home" component={() => (<p><FormattedMessage id="home.welcome" /></p>)} />
            </Switch>
          </div>
        </div>
      </HashRouter>
